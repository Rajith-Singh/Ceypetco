    ...
    <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th><center> Organized by </center></th>
                    <th><center> Mobile Number </center></th>
                    <th><center> Entered Date </center></th>
                    <th><center> Entered by </center></th>
            ...
            <tbody>
                @foreach($data as $data)
                    <tr>
                        ...
                        <td>{{$data->mobile}}</td>
                        <td>{{$data->entered_date_time}}</td>
                        <td>{{$data->entered_by}}</td>
                        <td><center>
                            <table>
                                <tr>
                                    <td> 
                                        <a href="/user/editProposal/{{$data->id}}" class="btn btn-success"> Update </a>
                                    </td> 

                                    <td> 
                                        <a href="/user/addComments/{{$data->id}}" class="btn btn-warning"> Add Comments </a>
                                    </td> 
                                </tr>    
                            </table></center>
                        </td>        
