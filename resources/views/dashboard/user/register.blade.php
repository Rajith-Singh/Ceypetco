            ...
            <div class="col-lg-7 col-md-6">
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2"></i>No.609, Dr. Danister de Silva Mawatha, Colombo 09.</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+94 11 5455455</p>
                        <p><i class="fa fa-envelope mr-2"></i>secratariat[at]ceypetco.gov.lk</p>
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: #3E3E4E !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a href="#">Ceylon Petroleum Corporation</a>. All Rights Reserved. 
