...
<body>
    ...
    <h2 style="font-size:35px;"> Add Proposal </h2> <br>
        <form class="row g-3" method="post" action="/saveProposal">
        ...
        @endif
			...
			<div class="col-md-12">
                ...
                <input type="text" class="form-control py-2" name="subject">
			...
			<div class="col-md-12">
                ...
                <input type="date" class="form-control py-2" name="data_time">
